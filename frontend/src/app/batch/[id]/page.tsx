            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
              ...
              <div className="flex items-center gap-3 text-gray-600">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-amber-700">{batchData.confidence}</p>
                </div>
              </div>
            </div>
          </div>
          
          <div className="flex flex-col items-center gap-3 bg-stone-50 p-4 rounded-xl border border-gray-100">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="space-y-4">
            <div className="bg-stone-50 p-4 rounded-lg">
              ...
              <a href={`https://sepolia.basescan.org/tx/${batchData.txHash}`} target="_blank" rel="noopener noreferrer" className="font-mono text-sm text-amber-700 hover:underline break-all">
                {batchData.txHash}
              </a>
            </div>
            <div className="bg-stone-50 p-4 rounded-lg">
              <p className="text-xs font-medium text-gray-500 uppercase mb-1">IPFS Image Reference (Pinata)</p>
              <a href={`https://gateway.pinata.cloud/ipfs/${batchData.ipfsHash}`} target="_blank" rel="noopener noreferrer" className="font-mono text-sm text-amber-700 hover:underline break-all">
